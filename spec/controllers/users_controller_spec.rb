...
describe UsersController do 
  ...
  describe "POST 'create'" do 
    ...
    describe "sucess" do
      ...
      it "should have a welcome message" do 
        post :create, :user => @attr
        flash[:success].should =~ /Thanks for taking the time/i
      end
      
    end #end of Describe Sucess
  ...
  describe "PUT 'update'" do 
    ...
    end #END of describe failure for PUT update 
    ...
    end #END of describe sucess for PUT update 
  ...
  describe "authentication of edit/update pages" do 
    ...
    end #END of describe for non-signed in users 
  ...
  end #END of authentication of update/edit pages    
...
end #END of describe Usercontroller
